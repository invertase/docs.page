...
function SidebarAnchor(props: {
	...
	const className = cn(
		"relative group flex items-center pr-5 py-[7.5px] text-[14.5px] gap-2",
	);
	...
	return (
		<div className="relative has-[.nav-link-active]:border-primary border-l border-white/10 pl-3 transition-all text-gray-300 hover:text-white hover:border-white/20">
			<div className="has-[.nav-link-active]:font-bold">{anchor}</div>
			{props.children}
		</div>
	);
}
