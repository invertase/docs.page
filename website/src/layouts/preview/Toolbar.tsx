...
export function Toolbar() {
  return (
    <div
      className="fixed bottom-8 h-12 z-50 rounded-full bg-neutral-800 px-2 py-1 text-white flex items-center space-x-2 border border-black/10 dark:border-white/10"
      style={{
        left: "50%",
            ...
            <div className="flex min-h-full items-center justify-center p-4">
              ...
              >
                <DialogPanel className="w-full max-w-2xl rounded-xl bg-black/80 p-6 backdrop-blur-2xl">
                  ...
                  <div className="max-h-[500px] overflow-auto min-w-0">
                    <div className="text-sm py-2 px-2 grid grid-cols-2 text-white">
                      {Object.keys(files.data || {}).map((key) => (
                        <Fragment key={key}>
                          <div className="border-b border-neutral-200/20 py-1">
                            <code>{key}</code>
                          </div>
                          <div className="border-b border-neutral-200/20 py-1">
                  ...
                  <div className="mt-2">
                    <Button
                      className="inline-flex items-center gap-2 rounded-md bg-neutral-950 py-1.5 px-3 text-sm/6 font-semibold text-white shadow-inner shadow-white/10 focus:outline-none data-[hover]:bg-neutral-800 data-[open]:bg-neutral-700 data-[focus]:outline-1 data-[focus]:outline-white"
