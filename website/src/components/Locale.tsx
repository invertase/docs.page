...
export function Locale() {
  ...
  return (
    <div>
      <Menu>
        <MenuButton className="flex items-center gap-1.5 bg-neutral-200/60 hover:bg-neutral-200/80 dark:bg-white/10 hover:dark:bg-white/20 transition-all rounded-full pl-4 pr-3 py-1.5 text-xs font-bold">
