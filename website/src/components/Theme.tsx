...
export function ThemeToggle() {
  ...
  return (
    <Switch
      ...
      onChange={setEnabled}
      className={cn(
        "relative inline-flex h-3 w-7 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent bg-neutral-200/60 transition-colors duration-200 ease-in-out dark:bg-white/10",
      )}
    >
      ...
      <span
        className={cn(
          ...
          {
            "border-primary translate-x-3 bg-neutral-950": enabled,
