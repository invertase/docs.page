...
export function Tweet(props: TweetProps) {
  ...
  return (
    <div
      ref={ref}
      className="[&>div]:mx-auto [&>div]:overflow-hidden [&>div]:rounded-[14px] [&>div]:border-[1px] [&>div]:border-solid [&>div]:border-zinc-200 [&>div]:shadow [&>div]:hover:shadow-lg [&>div]:dark:border-zinc-800 my-6 mx-auto"
      data-tweet={props.id}
    />
  );
}
