...
const BLOCK_LIST_REGEX =
  /^\/(wp-admin|wp-login\.php|wp-logout\.php|xmlrpc\.php|wp-content|wp-includes|wp-json|cgi-bin|\.env|administrator|admin|user|login|logout|register|signup|signin|dashboard|config|system|vendor|installation|magento|downloader|artisan|shell\.php|upload\.php|test\.php|phpinfo\.php|config\.php|configuration\.php|database\.sql|backup\.sql|db_backup|\.git|\.svn|\.hg|\.bzr|\.DS_Store|\.htaccess|\.htpasswd)(\/|$)/i;
