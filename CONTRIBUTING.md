...
We expect participants to follow our [Code of Conduct](CODE_OF_CONDUCT.md).
...
Run `bun run check` before opening a PR. Update `docs/` and [CHANGELOG.md](CHANGELOG.md) when behavior changes.
...
- Update docs/ and CHANGELOG.md if behavior is user-facing
