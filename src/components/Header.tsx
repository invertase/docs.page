...
export function Header() {
  ...
  return (
    <header className="px-4 sticky top-0 z-10 flex items-center justify-center h-16 bg-white text-sm dark:bg-gray-800 text-gray-900 dark:text-white border-b dark:border-gray-800">
