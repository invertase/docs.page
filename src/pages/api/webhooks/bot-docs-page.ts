...
const app = (app: Probot) => {
  app.on('pull_request.opened', async context => {
    ...
    // Comes through as `never` for some reason.
    const pull_request = context.payload.pull_request as PullRequestEvent;
...
export default createNodeMiddleware(app, { probot, webhooksPath: '/api/webhooks/bot-docs-page' });
