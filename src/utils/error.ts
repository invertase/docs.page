...
export interface ISerializationError {
  detail?: ISerializationDetail;
  location?: ISerializationLocation;
  notes?: string[];
  pluginName?: string;
  text?: string;
}

export interface ISerializationDetail {
  message?: string;
  name?: string;
  reason?: string;
  line?: string;
  column?: string;
  location?: ISerializationLocationExtraField;
  source?: string;
  ruleId?: string;
  fatal?: boolean;
}

interface ISerializationLocation {
  column?: string;
  file?: string;
  length?: string;
  line?: string;
...
interface ISerializationLocationExtraField {
  column: number;
  file: string;
  length: number;
  line: number;
