  ...
  return (
    <>
      ...
      <div className="mx-auto mt-32 max-w-5xl px-4 lg:px-0">
        ...
        <div className="mt-10 lg:ml-20 lg:flex"></div>
      </div>
      <div className="mx-auto mt-32 max-w-5xl px-4 lg:px-0">
        ...
        <div className="mt-10 grid gap-16 text-center lg:ml-20 lg:grid-cols-2">
          <Feature href="https://use.docs.page/configuration">
            ...
            <span slot="text">
              ...
              repository to configure your project by adding a theme, search, navigation, analytics
              and more.
            </span>
            <span slot="icon"></span>
          </Feature>
          ...
          <Feature href="https://use.docs.page/github-bot">
            ...
            <span slot="icon">{/* <!-- <AnnotationIcon width={80} /> --> */}</span>
          </Feature>
          <Feature href="https://use.docs.page/search">
            ...
            <span slot="icon">{/* <!-- <SearchCircleIcon width={80} /> --> */}</span>
          </Feature>
        </div>
