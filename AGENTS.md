...
- [review-doc](./skills/review-doc/SKILL.md) — review a `docs/*.mdx` page against writing checks (failing, passing, muted), apply unmuted findings by default, and loop until failing is 0. Use when the publisher names review-doc or asks to review writing. Not `docs check`.
