...
After you save on GitHub, the preview or production site updates on the next request—there is no separate publish step. See [Page actions](/features/github-hosting#page-actions) for the full header menu.
...
<CardGroup cols={2}>
  ...
  <Card title="Page actions" icon="copy" href="/features/github-hosting#page-actions">
