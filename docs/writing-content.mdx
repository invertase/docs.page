...
To render a diagram, use a code block with the `mermaid` language:

```mermaid
graph TD
    A[Write docs] --> B[Publish]
```

Learn more about diagram syntax in the [Mermaid component guide](/components/mermaid).
