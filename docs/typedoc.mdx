...
```
2. Add a `reference` field to your `docs.json` or `docs.yaml` configuration file. This value specifies the folder in which your references will be generated. If you're unsure, set it as `Reference` or `API`.
...
4. Run `docs_page typedoc` from your root directory.