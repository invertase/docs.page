...
docs.page uses [DocSearch](https://docsearch.algolia.com/) by Algolia to provide full, indepth rich search
...
You can also optionally provide your Application ID via the `appId` property to enable preconnection to help speed up
