...
Use `<Property>` to document a single field, parameter, or configuration key with a name, type badge, and optional **required** or **optional** labels. Put the description in the component body so you can use full MDX—code blocks, lists, callouts, and nested components.
...
Component reference pages in this section use `<Property>` blocks for component properties. Use markdown tables for behaviour matrices and when-to-use comparisons instead.
