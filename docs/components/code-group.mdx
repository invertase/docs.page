...
Only fenced code blocks inside `<CodeGroup>` become tabs. Other MDX content is ignored. The renderer passes parsed blocks to the component internally—you do not set a `blocks` property in MDX.
