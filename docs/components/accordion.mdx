---
title: Accordion
description: Collapsible Accordion panels and AccordionGroup layouts for FAQs and optional detail.
---
...
| --- | --- | --- | --- |
| `title` | `string` | Yes | Text shown on the panel trigger |
| `defaultOpen` | `boolean` | No | Whether the panel starts expanded |
...
| --- | --- | --- | --- |
| `type` | `"single"` \| `"multiple"` | `"multiple"` | How many panels can stay open at once |
...
<AccordionGroup>
  ...
  <Accordion title="Click to expand">
    Grouped accordions stack in a single panel.
  </Accordion>
  <Accordion title="Another section">
