...
Somewhere in your MDX file, add an export which returns a React component. For example:
...
- <Icon name="check" /> You use React state.
...
You can use React state in your components. For example:
...
Here's a real-life example: <Counter />
