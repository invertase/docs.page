...
<Property name="sidebar" type="Sidebar[] | Record<string, Sidebar>">
  ...
  <Accordion title="Sidebar">
    ...
    <Property name="tab" type="string | string[]">
      If provided, only show this sidebar item when viewing a specific [tab](/navigation#tabs). Pass a string to restrict to one tab, or an array of tab ids to show the item on multiple tabs.
    </Property>
  </Accordion>
</Property>