...
Next, [create a Pull Request](https://github.com/invertase/docs.page/blob/master/repositories.json) to add your repository to the `repositories.json` file at the root of the docs.page repository.

Whenever the project undergoes a new build, each repository within the `repositories.json` file will be queried, and the paths provided will be built.
