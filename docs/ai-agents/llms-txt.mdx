...
For very large repositories, the response may include an `x-docs-page-tree-truncated: 1` header—the export can be incomplete. Use [MCP server](/ai-agents/mcp-server) to read individual pages instead.
