---
title: MCP client
description: Learn what the per-repo MCP endpoint provides, how agents use it, and how to connect a client or disable it.
---
...
- A published docs URL you can open in a browser — see [Agent-ready docs](/ai-agents/agent-ready-docs)
...
- [Agent-ready docs](/ai-agents/agent-ready-docs) — how MCP fits alongside llms.txt and Ask AI
- [Page actions](/features/github-hosting#page-actions) — **Install with MCP**, **Connect to Cursor**, and **Connect to VSCode** in the header menu
