...
- A **public** GitHub repository — programmatic routes require public visibility (see [Public GitHub hosting](/features/github-hosting))
...
| **MCP server** | On by default | [MCP client](/ai-agents/mcp-server) |
...
Every surface reads from the public GitHub repository and ref that power your docs site. Push an MDX update and exports, MCP listings, and Ask AI search reflect it on the next request—the same model as [Public GitHub hosting](/features/github-hosting).
...
See [Page actions](/features/github-hosting#page-actions) for the full menu list and [MCP client](/ai-agents/mcp-server#connect-from-the-live-site) for setup from the live site.
...
<CardGroup cols={2}>
  ...
  <Card title="MCP client" icon="plug" href="/ai-agents/mcp-server">
