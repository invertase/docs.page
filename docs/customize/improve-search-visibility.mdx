...
Field types and defaults: [docs.json](/reference/docs-json-reference).
...
- [docs.json](/reference/docs-json-reference) — `name`, `description`, `socialPreview`, and `seo.noindex`
