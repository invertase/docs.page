...
- Optional: a [custom domain](/customize/custom-domain) when you want canonical URLs on your own host
...
- [Connect a custom domain](/customize/custom-domain) — serve docs and crawler files on your own domain
