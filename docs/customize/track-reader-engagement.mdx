...
<Steps>
  ...
  <Step title="Declare scripts in docs.json">
    ...
    For field types, optional keys, and additional examples, see [Analytics providers](/reference/analytics-providers).
  </Step>
...
- [Analytics providers](/reference/analytics-providers) — full `scripts` field reference
