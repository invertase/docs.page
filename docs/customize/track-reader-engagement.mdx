...
- Theme and layout already set — see [Apply your branding](/customize/apply-your-branding) if you have not configured `docs.json` yet
...
- For **Plausible** only: a [custom domain or vanity subdomain](/customize/connect-a-custom-domain) mapped to your docs. Plausible requires a resolved hostname
  ...
  <Step title="Declare scripts in docs.json">
    ...
    <Tabs>
      ...
      <TabItem label="Plausible" value="plausible">
        ...
        Plausible needs a mapped domain — configure [Connect a custom domain](/customize/connect-a-custom-domain) before you verify.
      </TabItem>
    </Tabs>

    For field types, optional keys, and additional examples, see [docs.json — scripts](/reference/docs-json-reference#scripts).
  </Step>
...
| Plausible script never loads | No custom domain or vanity subdomain on the request | [Connect a custom domain](/customize/connect-a-custom-domain) and open the site on that hostname |
...
- [docs.json — scripts](/reference/docs-json-reference#scripts) — full `scripts` field reference
- [Connect a custom domain](/customize/connect-a-custom-domain) — required hostname for Plausible
