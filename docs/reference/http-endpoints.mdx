...
Browser-only chat endpoint for [Ask AI](/features/ask-ai) and [custom same-origin chat UI](/ai-agents/embed-ask-ai). Not a public API; it requires session cookies issued when a reader loads a production doc page.
...
See [Ask AI](/ai-agents/ask-ai), [Embed Ask AI](/ai-agents/embed-ask-ai), and [docs.json](/reference/docs-json).
