...
Browser-only chat endpoint for [Ask AI](/features/ask-ai) and [custom same-origin chat UI](/ai-agents/embed-ask-ai). Not a public API — requires session cookies issued when a reader loads a production doc page.
