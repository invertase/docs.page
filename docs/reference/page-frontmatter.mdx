...
<Property name="title" type="string">
  ...
  Falls back to the site `name` from `docs.json` when omitted. With [`docs check --metadata`](/reference/cli-reference), warns when `title` is missing on pages that use auto-generated social preview images.
</Property>
...
<Property name="description" type="string">
  ...
  Falls back to the site `description` from `docs.json` when omitted. With [`docs check --metadata`](/reference/cli-reference), warns when `description` is missing on pages that use auto-generated social preview images.
</Property>
...
<Property name="showPageTitle" type="boolean">
  ...
  When omitted, inherits [`content.showPageTitle`](/reference/docs-json-reference) from `docs.json`. Default site value: `true`.
</Property>
...
<Property name="showPageImage" type="boolean">
  ...
  When omitted, inherits [`content.showPageImage`](/reference/docs-json-reference) from `docs.json`. Default site value: `true`.
</Property>
...
<Property name="noindex" type="boolean">
  ...
  Site-wide blocking uses [`seo.noindex`](/reference/docs-json-reference) in `docs.json` instead. See [Search engine indexing](/features/search-engine-indexing).
</Property>
...
<Property name="previous" type="string">
  Root-relative path for the **Previous** footer link. Overrides sidebar-inferred navigation when [`content.automaticallyInferNextPrevious`](/reference/docs-json-reference) is enabled.
...
- [docs.json](/reference/docs-json-reference) — site-wide defaults that frontmatter can override
- [CLI](/reference/cli-reference) — `docs check --metadata` for missing title and description
- [Write](/authoring/write) — page structure, links, and media
- [Organise](/authoring/organise) — sidebar order that drives default previous/next links
