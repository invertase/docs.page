...
docs.page ships opinionated defaults for **developer documentation**: [sidebar groups and tabs](/features/navigation-tabs), [full-text search](/features/search), [built-in MDX components](/features/components), [branch previews](/features/branch-preview), and [page actions](/features/github-hosting#page-actions) for contributors and integrators.
...
- [Public GitHub hosting](/features/github-hosting) — how Git becomes a live site
- [Components](/features/components) — built-in MDX without imports
- [Agent-ready docs](/ai-agents/agent-ready-docs) — programmatic access from the same repo
- [docs.page vs GitHub Pages](/comparisons/docs-page-vs-github-pages) — Jekyll's common deploy target
