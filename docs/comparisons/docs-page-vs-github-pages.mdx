...
docs.page reads `docs.json` and `docs/**/*.mdx` from a **public GitHub repository** and returns a complete documentation site on push — no Pages project, no workflow YAML, no artifact upload. Search, themes, branch previews, and [agent surfaces](/ai-agents/agent-ready-docs) are part of the platform, not plugins you wire up.

See [Public GitHub hosting](/features/github-hosting) for the docs.page request model.
...
- [docs.page vs Docusaurus](/comparisons/docs-page-vs-docusaurus) — a common generator behind Pages
