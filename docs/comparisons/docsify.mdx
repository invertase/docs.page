...
docs.page also reads markdown from Git, but bundles and serves a full documentation site from **public GitHub repositories** (navigation, search, themes, branch previews, and [agent-ready exports](/ai-agents/overview) without assembling those pieces yourself).
...
- [Public GitHub hosting](/features/public-github-hosting): push-to-publish from Git
- [Local preview](/features/local-preview): iterate before you push
- [Agent-ready docs](/ai-agents/overview): llms.txt and MCP from the same repo
- [docs.page vs Jekyll](/comparisons/jekyll): another self-hosted static path
