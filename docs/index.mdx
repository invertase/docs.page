...
- **Open-source maintainers and SDK authors** who want docs that stay in sync with source code, without [Docusaurus](/comparisons/docusaurus) builds, deploy pipelines, or hosting to maintain.
