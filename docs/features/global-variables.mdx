...
They are not a templating language: there is no logic, conditionals, or partials. For one-off page metadata, use frontmatter. For field-level config lookup, see [docs.json](/reference/docs-json-reference#variables).

## Related

<CardGroup cols={2}>
  <Card title="docs.json" icon="code" href="/reference/docs-json-reference#variables">
