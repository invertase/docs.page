...
Contributors fixing typos without a local clone can use **Edit page** from any live or branch preview URL—see [Publish](/authoring/publish#edit-a-page-on-github). For agent setup from the menu, see [MCP client](/ai-agents/mcp-server#connect-from-the-live-site).
