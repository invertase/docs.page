...
Search is separate from **search engine indexing** (sitemap, `robots.txt`, and SEO metadata). On-site search helps readers who are already on your docs; SEO settings help Google and other crawlers find your site. See [Improve search visibility](/customize/improve-search-visibility) for crawler-facing configuration.
