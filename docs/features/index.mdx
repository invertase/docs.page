...
<CardGroup cols={2}>
  ...
  <Card title="Social links" icon="share-nodes" href="/features/social-links">
    Show social profiles and Open Graph metadata in the site chrome for richer social sharing.
  </Card>
...
- [Reference](/reference) — docs.json fields, CLI flags, and HTTP endpoints
- [Publish your first site](/publish-your-first-site) — get a live site in minutes
