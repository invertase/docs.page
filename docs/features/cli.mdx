...
For a full first-publish walkthrough including GitHub push, follow [Quickstart](/publish-your-first-site).
...
- [Quickstart](/publish-your-first-site) — scaffold and go live
