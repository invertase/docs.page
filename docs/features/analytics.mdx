...
<CardGroup cols={2}>
  <Card title="Track reader engagement" icon="chart-simple" href="/customize/track-reader-engagement">
    Add analytics keys to docs.json and confirm events on your live site.
  </Card>
  <Card title="Analytics providers" icon="book-open" href="/reference/analytics-providers">
