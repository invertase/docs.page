...
For step-by-step rename workflows, see [Update moved pages](/authoring/update-moved-pages). Field syntax and other frontmatter options live in [Page frontmatter](/reference/page-frontmatter).
...
<CardGroup cols={2}>
  <Card title="Update moved pages" icon="arrow-right-arrow-left" href="/authoring/update-moved-pages">
