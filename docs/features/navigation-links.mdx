...
Your sidebar is for documentation pages — but readers often need a link that is not a doc page. A source repository, issue tracker, or sign-in URL does not belong in a navigation group. Anchor links place those shortcuts in the sidebar chrome so they stay visible without reshaping the sidebar tree.
...
When your site uses [locales](/features/locales) or [tabs](/features/navigation-tabs), you can limit which anchors appear in a given context:
