...
For every field name and accepted value shape, see [docs.json reference](/reference/docs-json-reference).
...
<CardGroup cols={2}>
  <Card title="Theme" icon="palette" href="/features/theme">
    How light and dark mode, presets, and colors shape the site chrome around your logo.
  </Card>
  ...
  <Card title="Apply your branding" icon="paintbrush" href="/customize/apply-your-branding">
