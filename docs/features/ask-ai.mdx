...
**Open in Claude** in the [page action menu](/features/github-hosting#page-actions) is separate—it opens Claude on the web with the current page URL. It does not use Ask AI credentials or search your full doc set.
...
For delete, rotate keys, provider flags, and troubleshooting, see [Manage the AI agent](/features/cli#manage-the-ai-agent) on the CLI page and [`docs agent create`](/reference/cli-reference#docs-agent-create) in the CLI.
...
<CardGroup cols={2}>
  ...
  <Card title="CLI" icon="book" href="/reference/cli-reference">
