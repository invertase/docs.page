...
1. **Open a terminal at your project root** — the directory that contains `docs.json`.
...
3. **Edit and save.** Change any watched file under `docs/` or update `docs.json`. The preview reloads without a Git push.

4. **Customize port or browser behavior when needed.**
