...
This tutorial walks you through your first publish: scaffold the required files, push them to a public GitHub repository, and open your live [docs.page](https://docs.page) URL. When you finish, your documentation site is on the web with no build step or hosting setup required.
