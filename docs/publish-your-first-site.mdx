...
<Steps>
  ...
  <Step title="Open your live site">
    ...
    **Congratulations — your docs site is officially published.** Pushes to your default branch update this live site automatically with zero build steps. See [Public GitHub hosting](/features/github-hosting) for how production URLs work.
  </Step>
</Steps>
...
- [Agent-ready docs](/ai-agents/agent-ready-docs) — llms.txt, MCP, and optional Ask AI on your live site
