...
<Steps>
  ...
  <Step title="Open your live site">
    ...
    Pushes to your default branch update this URL automatically with no build step. See [Public GitHub hosting](/features/github-hosting) for how production URLs work.
  </Step>
</Steps>
...
- [Organize](/authoring/organise) — order sidebar groups, tabs, and page links in `docs.json`
