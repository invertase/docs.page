      ...
      >
        ...
        <div className="relative z-10 mx-auto flex min-h-svh w-full min-w-0 max-w-8xl flex-col px-0 font-mono md:px-4">
          <div className="flex min-h-svh flex-1 flex-col md:border-x">
            <Header />
            <main className="flex flex-1 flex-col items-center justify-center overflow-hidden px-6 py-8 text-center [--not-found-title:2.25rem] sm:[--not-found-title:3rem] md:[--not-found-title:3.75rem]">
              <NotFoundTriangleLed />
