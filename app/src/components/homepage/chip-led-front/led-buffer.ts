...
/** Keep crawl °/s the same when LEDS_PER_EDGE changes (velocities are LED-index/s). */
const CRAWL_SPEED_SCALE = LEDS_PER_EDGE / 24;
const LINE_VELOCITIES = [
  -3.302 * PERIMETER_SCALE * CRAWL_SPEED_SCALE,
  -2.355 * PERIMETER_SCALE * CRAWL_SPEED_SCALE,
  -1.636 * PERIMETER_SCALE * CRAWL_SPEED_SCALE,
] as const;
...
function updateDeployingRgb(leds: LedGeometryState, target: Float32Array) {
